...
const Banner: React.FC<BannerProps> = ({ banners = [] }) => {
  ...
  const getBannerImage = (banner: any) => banner.image || banner.image_url;
    ...
    <div className="relative h-96 md:h-[500px] overflow-hidden bg-gray-100">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${getBannerImage(activeBanners[currentSlide])})`,
          }}
        >
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl text-white">
              ...
              {activeBanners[currentSlide].link_url && (
                <a
                  href={activeBanners[currentSlide].link_url}
